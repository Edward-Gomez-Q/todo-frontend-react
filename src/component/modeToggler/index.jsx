...
function ModeToggler() {
  ...
  return (
    <button
      ...
      id="theme-toggle"
      onClick={toggleMode}
      className="relative flex h-[20px] w-[20px] items-center justify-center rounded-[12px] border border-success-300 dark:border-darkblack-400 overflow-hidden">
    
        <span className="block dark:hidden">
    <svg
      className="h-full w-full stroke-bgray-900"
      viewBox="0 0 24 24"
      fill="none"
  ...
  <span className="hidden dark:block">
    <svg
      className="h-full w-full stroke-bgray-900 dark:stroke-bgray-50"
      viewBox="0 0 24 24"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
